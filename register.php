                        ...
                        if (empty($_POST['password'])) {
                            ...
                            if (strlen($password) < 8) {
                                ...
                                if ($password !== $confirmPassword) {
                                    ...
                                    $sql = "INSERT INTO users (username, first_name, last_name, password, email, is_admin) values ('$username', '$firstName', '$lastName', '$password', '$email', 'false')";
