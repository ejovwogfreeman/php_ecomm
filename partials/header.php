            ...
            <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                <ul class="navbar-nav">
                    ...
                    <?php if (isset($_SESSION['user']) && $_SESSION['user'][0]['is_admin'] === 'true') : ?>
                        <li class="nav-item"><a href="/php_ecommerce/admin" class="nav-link text-light text-decoration-none mt-1 me-3">Admin</a></li>
                        <li class="nav-item"><a href="/php_ecommerce/admin/upload_product.php" class="nav-link text-light text-decoration-none mt-1 me-3">Upload Product</a></li>
                    <?php endif ?>
